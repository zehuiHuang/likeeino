...
require (
	...
	github.com/cloudwego/eino-ext/components/indexer/milvus v0.0.0-20251219073121-0fff9abbb56c
	...
	github.com/cloudwego/eino-ext/components/retriever/milvus v0.0.0-20251219073121-0fff9abbb56c
